"""
BiSeNet implementation matching zllrunning/face-parsing.PyTorch
"""
...
class BiSeNet(nn.Module):
    ...
    def forward(self, x):
        ...
        feat_sp = feat_res8  # 128 channels from ResNet layer2
        feat_fuse = self.ffm(feat_sp, feat_cp8)  # 128 + 128 = 256 channels
